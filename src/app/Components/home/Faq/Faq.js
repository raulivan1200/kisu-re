...
function Faq() {
    ...
    const faqData = [
        ...
        { toggleText: 'Do you only create websites', contentText: "No, our expertise extends beyond website development. We are a versatile team, proficient in crafting dynamic solutions across various digital platforms. In addition to creating captivating websites, we excel in developing robust software solutions and innovative mobile applications for both Android and iOS platforms. Our commitment is to bring your ideas to life, ensuring they seamlessly integrate across the digital landscape and provide exceptional user experiences."},
